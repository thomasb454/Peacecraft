package com.peacecraftec.schematic;
...
public class Schematic {
    public static Schematic load(File file) {
        ...
        try {
            ...
            System.err.println("[PeacecraftCore] Failed to load schematic \"" + file.getName() + "\".");
            e.printStackTrace();
            return null;
        } finally {
            if(in != null) {
    ...
    public static Schematic load(InputStream in) {
        ...
        try {
            ...
            System.err.println("[PeacecraftCore] Failed to load schematic.");
            e.printStackTrace();
            return null;
        }
    ...
    public static void save(Schematic schematic, File file) {
        ...
        try {
            ...
            System.err.println("[PeacecraftCore] Failed to save schematic \"" + file.getName() + "\".");
            e.printStackTrace();
        } finally {
            if(out != null) {
                try {
    ...
    public static void save(Schematic schematic, OutputStream out) {
        ...
        try {
            ...
            System.err.println("[PeacecraftCore] Failed to save schematic.");
            e.printStackTrace();
        }
    }
