...
public class YamlStorage extends MapBasedStorage {
    ...
    private static SafeConstructor createConstructor() {
        try {
            ...
            System.err.println("[PeacecraftCore] Could not create YAML constructor.");
            e.printStackTrace();
            return null;
        }
    }
    ...
    private static Representer createRepresenter() {
        try {
            ...
            System.err.println("[PeacecraftCore] Could not create YAML representer.");
            e.printStackTrace();
            return null;
        }
    }
    ...
    public void save(OutputStream out) {
        ...
        try {
            ...
            System.err.println("[PeacecraftCore] Failed to save config file to stream!");
            e.printStackTrace();
        } finally {
            if(writer != null) {
                try {
