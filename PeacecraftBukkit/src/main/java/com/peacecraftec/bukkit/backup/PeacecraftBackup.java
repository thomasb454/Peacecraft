...
public class PeacecraftBackup extends Module {
    ...
    public void initiateBackup() {
        this.backupTask = this.getManager().getScheduler().runTaskAsynchronously(this, new Runnable() {
            ...
            public void run() {
                backingUp = true;
                broadcastMessage("backup.broadcast.initiating");
                ...
                for(String world : getConfig().getList("worlds", String.class)) {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        broadcastMessage("backup.broadcast.error");
                        cancelled = false;
                        backingUp = false;
                        return;
                    }
                ...
                broadcastMessage("backup.broadcast.finished");
                backingUp = false;
                cancelled = false;
            }
            ...
            private void cancelled() {
                broadcastMessage("backup.broadcast.cancelled");
                cancelled = false;
                backingUp = false;
            }
        });
