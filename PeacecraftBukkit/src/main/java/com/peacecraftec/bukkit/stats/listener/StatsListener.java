...
import com.peacecraftec.util.ExpUtil;
...
public class StatsListener implements Listener {
	...
	public void onPlayerExpChange(PlayerExpChangeEvent event) {
		this.module.getStatSystem().setStat("status.levels", event.getPlayer().getName(), ExpUtil.getLevelForExp(ExpUtil.getCurrentExp(event.getPlayer().getLevel(), event.getPlayer().getExp()) + event.getAmount()));
	}
