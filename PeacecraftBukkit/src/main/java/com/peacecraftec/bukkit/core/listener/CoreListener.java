            ...
            if(item != null && item.getType() == Material.WOOD_AXE) {
                ...
                if(meta != null && meta.getDisplayName() != null && meta.getDisplayName().equals(ChatColor.GOLD + "Peacecraft Wand")) {
                    if(event.getAction() == Action.LEFT_CLICK_BLOCK) {
                        ...
                        sendMessage(event.getPlayer(), "core.first-pos-set", event.getClickedBlock().getX(), event.getClickedBlock().getY(), event.getClickedBlock().getZ());
                        ...
                        sendMessage(event.getPlayer(), "core.second-pos-set", event.getClickedBlock().getX(), event.getClickedBlock().getY(), event.getClickedBlock().getZ());
                        event.setCancelled(true);
                    }
                }
            }
