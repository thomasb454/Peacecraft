...
public class PermissionManager {
    ...
    public int getTotalPlayers() {
        return this.module.getConfig().getInteger("core.total-players");
    }

    public void playerJoined() {
        this.module.getConfig().setValue("core.total-players", this.getTotalPlayers() + 1);
        this.module.getConfig().save();
    }
    ...
    public void reload() {
        ...
        this.module.getConfig().applyDefault("core.total-players", 0);
        this.module.getConfig().save();
