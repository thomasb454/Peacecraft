...
public class PeacecraftPerms extends Module {
    ...
    public void onEnable() {
        ...
        PeacePermsVault vault = new PeacePermsVault(this.manager);
        VaultAPI.setPermissions(new PeacePermsVault(this.manager));
        VaultAPI.setChat(new PeaceChatVault(vault, this.manager));
                                ...
                                if(w.isAutoRanked(group)) {
                                    ...
                                    if(minutes >= w.getRankMinutes(group)) {
                                        ...
                                        if(w.getGroup(to) != null) {
                                            p.removeGroup(group);
                                            p.addGroup(to);
                                            sendMessage(player, "perms.auto-ranked-up", group, to);
                                        }
                                    }
                                }
                            }
